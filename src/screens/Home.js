    ...
    <Container style={styles.parent}>
      <Content padder>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={() => viewAllItem('created_at')}>
            <Text style={styles.subtitle}>View all</Text>
          </TouchableOpacity>
        </View>
        {product.newProductsIsLoading && <Spinner color="green" />}
        <ScrollView horizontal>
          {product.newProductsData.length > 0 &&
            product.newProductsData.map((item) => {
              return (
        ...
        <ScrollView horizontal>
          {product.popularProductsData.length > 0 &&
            product.popularProductsData.map((item) => {
              return (
                <Card style={styles.card} key={item.id}>
                  <CardItem cardBody>
                    <Image
